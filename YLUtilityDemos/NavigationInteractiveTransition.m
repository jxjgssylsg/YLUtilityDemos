...
- (void)handleControllerPop:(UIPanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) { // 手势状态
        /**
         *  手势开始，新建一个监控对象
         */
        ...
        NSLog(@"syl --  here are pop la 意林~~哈哈!!!!");
    }
        ...
        if (progress > 0.5) {
            [self.interactivePopTransition finishInteractiveTransition];
             NSLog(@"syl -- finishInteractiveTransition  意林~~哈哈!!!!");
        }
        else {
            [self.interactivePopTransition cancelInteractiveTransition];
             NSLog(@"syl -- cancelInteractiveTransition  意林~~哈哈!!!!");
        }
